...
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Una sola implementación de errores HTTP serializables y de lectura de cuerpo JSON                                                                                                             | + `src/lib/httpJson.ts`; ~ `src/app/api/internal/_lib/issues.ts`, `src/features/orders/types.ts`                                                                                                  | —                            | `verify.sh F-011` → 0 con los tests de `/api/internal/*` pasando sin cambios                                                                                           |
