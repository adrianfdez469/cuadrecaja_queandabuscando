...
| ----- | ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| S-007 | Envío por zonas: `ZONE_BASED`, tarifario por zona y `contact.zoneCode` | **2026-09-09: el borrador de la v13 salió hacia vosotros** (F-041 en construcción), con el índice de 184 zonas adjunto y su sha256 citado en el propio contrato. `ZONE_TARIFF` con `rule` y **sin `DELETE`**, la precedencia con letra, el vector de trece casos y la cascada `STORE → ZONE_TARIFF` ya están escritos — publicar espera vuestro visto bueno sobre el borrador y que F-041 cierre `bash .agent/verify.sh F-041 --full` en verde. Lo que ve el comprador (selector, mapa, `contact.zoneCode`) es F-042, y depende de este. **2026-09-09, su veredicto: «OK a la forma, condicionado a nueve puntos»**, en `.agents/solicitudes-qab.md` de su repositorio. Revisaron el diseño, no este borrador —lo leyeron con el contrato todavía en v12.2—, así que **tres de sus nueve ya los cumple**: la tercera flecha de dependencia (punto 3), los diez casos con camino y guardas dentro (punto 5) y el padre explícito en vez de deducido de dos dígitos (el núcleo del punto 4). **Postura del humano el 2026-09-09**: sus puntos 1 y 2 pasan a features propios, **F-043** (un `zoneCode` desconocido falla solo su evento y no el lote — corrige el criterio 6 de F-041, que la regla 3 no deja editar; entra **antes** de publicar la v13) y **F-044** (el tarifario entra en la reconciliación con su hash por sucursal); los puntos 6, 7 y 9 y los cinco menores se cierran **dentro de F-041**, en el paso 17 del plan, que volvió a firma por eso; y la generalización del punto 4 —`parentCode`, cadena de padres y tercer nivel— **no entra ahora**, porque el núcleo ya está resuelto y generalizarla cambia el artefacto y el vector. **2026-09-10: su punto 1 está cerrado, F-043 construido y verificado.** El `400` de lote por una zona desconocida **ya no existe**: un `zoneCode` que no está en el catálogo **o que no tiene la forma del DPA** —no distinguimos las dos causas, a propósito— responde `207` con **ese** evento en `failed[]` y los demás del lote se aplican. El código sigue siendo `ZONE_TARIFF_ZONE_UNKNOWN`, byte a byte el mismo, y sigue declarado **reintentable**; con un código mal formado agota los reintentos de ese evento y de ninguno más. El borrador va por **v13.2**: se retiró el ejemplo del `400` que se llevaba 499 eventos y se corrigió, de paso, una promesa que era falsa desde la v9 —un `STORE` que falla por su zona no aplica ningún campo **de la sucursal**, pero el nombre del negocio y su moneda base sí pueden haberse escrito—. Nada de esto les obliga a cambiar lo que ya tienen: para su `planOutboxAck` es estrictamente mejor. **2026-09-10: su punto 2 está cerrado, F-044 construido y verificado.** El tarifario entra en la reconciliación con su propio hash por sucursal: `GET /api/internal/reconciliation?storeId=` responde ahora `{products, hash, tariffs, tariffHash}` — dos campos **aditivos**, la misma llamada, el mismo `404 UNKNOWN_STORE`, y quien lea la v12.1 los ignora y sigue siendo un lector correcto. El § ⑤ publica el hash con su pseudocódigo, su SQL espejo y su **vector de prueba calculado ejecutando**, que el test lee del propio documento y no de una copia. Cuatro cosas que necesitáis para construir el espejo de vuestro lado: (a) entran las filas de `rule` `FEE` y `NOT_SERVED`, y las de `INHERIT` **no** —`INHERIT` y «no hay fila» son el mismo veredicto—, así que el hash no distingue esos dos casos: costo aceptado y escrito, y un `INHERIT` perdido se sigue detectando porque de este lado queda la fila vieja; (b) el orden es **por bytes** de `zoneCode`, nunca un `ORDER BY`, porque dos colaciones sobre los mismos datos dan hashes distintos; (c) el importe se serializa como el precio de productos, sin ceros de relleno (`0.00` da `0`) y el hueco del importe de un `NOT_SERVED` es la cadena vacía, que ninguna cantidad válida produce; (d) cero filas dan `tariffs: 0` y `tariffHash` `d41d8cd98f00b204e9800998ecf8427e` —el md5 de la cadena vacía—, no un error ni una cadena ambigua. El SQL espejo va sobre los nombres del **cable** (`storeId`, `zoneCode`, `rule`, `deliveryFee`) y no sobre columnas vuestras, porque vuestra tabla de tarifario todavía no existe —vuestra F-013 la deja «su forma exacta es del arquitecto»—: ajustad los nombres, que lo que fija la semántica es el vector. Y lo que **no** hacemos, dicho a propósito en el contrato en vez de tapado: no hay recuperación automática del tarifario. `INHERIT` es la única retracción que existe, así que una fila que sobre de este lado no la podemos borrar desde aquí — la corrige un `ZONE_TARIFF` vuestro con `rule: "INHERIT"` y un `updatedAt` posterior. El hash **alerta**; la convergencia es vuestra. El borrador va por **v13.4**. **2026-09-10: PUBLICADA.** Revisaron el borrador sobre la v13.4 y dieron su visto bueno, así que el contrato deja de ser borrador y sale como **v13.5**: no cambia ni una regla ni un campo respecto a la v13.4 —solo el estado de publicación— y **retira el aviso** que reservaba `ZONE_BASED` y `ZONE_TARIFF`, porque el lado receptor ya está en pie (F-041 a F-045, todos en `passes: true`). Ya pueden emitir los dos. El aviso se retiró además porque había dejado de ser cierto: decía que `entity` no admitía `ZONE_TARIFF` y que un evento así se llevaba el lote con un `400 INVALID_BATCH`, y hoy es un miembro más de la unión de eventos (`src/features/sync/schemas.ts`). **Pendiente de anotar:** su visto bueno vino con un plan para ajustar detalles cuyo contenido no está en ninguno de los dos documentos; cuando se conozca va aquí, y si toca lo que el POS envía o recibe, en una versión **mayor** coordinada con ellos | **v13** · **F-041**, **F-042**, **F-043** y **F-044** · borrador revisado, nueve puntos triados · **puntos 1 y 2 cerrados (F-043, v13.2 · F-044, v13.4)** · reabre la ADR 0028 (0033 la estrecha, 0034 la enmienda) |
