---
feature: F-027
actualizado: 2026-08-29T03:42:43Z
...
- Hizo: trasladó .agent/specs/propuestas/filtros-y-ordenamiento-avanzados.md a spec.md, resolviendo SP1/SP2/SP3/SP4/SP5 con la recomendación del agente (aceptada por el humano) y marcando los 16 criterios como [ya].
- Escribió: .agent/specs/F-027/spec.md (estado: listo)
- Deja pendiente: architecture.md y design.md en blanco. Coordinar con F-026 el nombre del parámetro de categoría antes de fijar el vocabulario de querystring (SP2).
- Siguiente agente sugerido: sdd-architect (define el vocabulario de parámetros y confirma que el filtrado en memoria escala para el volumen real)
